...
class FillPermissionsForScd41Reading extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForScd41Reading constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.scd41-reading',
            'admin.scd41-reading.index',
            'admin.scd41-reading.create',
            'admin.scd41-reading.show',
            'admin.scd41-reading.edit',
            'admin.scd41-reading.delete',
            'admin.scd41-reading.bulk-delete',
        ]);
