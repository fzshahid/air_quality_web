...
class FillPermissionsForSps30Reading extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSps30Reading constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.sps30-reading',
            'admin.sps30-reading.index',
            'admin.sps30-reading.create',
            'admin.sps30-reading.show',
            'admin.sps30-reading.edit',
            'admin.sps30-reading.delete',
            'admin.sps30-reading.bulk-delete',
        ]);
