...
class FillPermissionsForAirQualityReading extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAirQualityReading constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.air-quality-reading',
            'admin.air-quality-reading.index',
            'admin.air-quality-reading.create',
            'admin.air-quality-reading.show',
            'admin.air-quality-reading.edit',
            'admin.air-quality-reading.delete',
            'admin.air-quality-reading.bulk-delete',
        ]);
