...
class FillPermissionsForCcs811Reading extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCcs811Reading constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ccs811-reading',
            'admin.ccs811-reading.index',
            'admin.ccs811-reading.create',
            'admin.ccs811-reading.show',
            'admin.ccs811-reading.edit',
            'admin.ccs811-reading.delete',
            'admin.ccs811-reading.bulk-delete',
        ]);
